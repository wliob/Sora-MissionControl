...
| 2026-06-22 | korra     | sora/biscuit/cloud/tifa/lelouch | `korra-reset01-product-spec.md`; `reference/hermes-dashboard-*.png`; `reference/*-dom-notes.json` | Reset 01 product/design contract: faithful Hermes Dashboard TUI clone first, built-in office panel second. Includes reference screenshots/DOM notes, target IA/layout, exact office placement/behavior, forbidden drift list, Biscuit dependencies, visual rubric, and Sora screenshot pass/fail checklist. |
